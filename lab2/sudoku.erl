...
worker() ->
  receive
    {Ref, Row, Parent} -> Parent ! {Ref,refine_row(Row)},
                                whereis(worker_pool) ! {available, self()}
  end.



% From 19.6 to 13.7 seconds
